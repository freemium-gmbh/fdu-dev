		...
		private void SetImageSource(MessageBoxImage image)
		{
			switch (image)
			{
				...
				case MessageBoxImage.Error:
					MessageImageSource = new BitmapImage(new Uri("pack://application:,,,/DriverUtilites.Infrastructure;component/Images/icon-err.png"));
					break;

				//case MessageBoxImage.Exclamation:
				case MessageBoxImage.Warning:
					MessageImageSource = new BitmapImage(new Uri("pack://application:,,,/DriverUtilites.Infrastructure;component/Images/icon-exclamation.png"));
					break;

				case MessageBoxImage.Question:
					MessageImageSource = new BitmapImage(new Uri("pack://application:,,,/DriverUtilites.Infrastructure;component/Images/icon-question.png"));
					break;

				//case MessageBoxImage.Asterisk:
				case MessageBoxImage.Information:
					MessageImageSource = new BitmapImage(new Uri("pack://application:,,,/DriverUtilites.Infrastructure;component/Images/icon-guard.png"));
					break;
